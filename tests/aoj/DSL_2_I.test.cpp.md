...
data:
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DSL_2_I\"\n#include\
    ...
    \    int N,Q;\n    std::cin>>N>>Q;\n    LazySegmentTree<Monoid::AssignSum<ll>>\
    \ seg(N);\n    while(Q--){\n        int op,x,y,val;\n        std::cin>>op>>x>>y;\n\
    \        if(op==0){\n            std::cin>>val;\n            seg.apply(x,y+1,val);\n\
    \        }else{\n            std::cout<<seg.prod(x,y+1)<<std::endl;\n        }\n\
    \    }\n}"
...
layout: document
redirect_from:
- /verify/tests/aoj/DSL_2_I.test.cpp
- /verify/tests/aoj/DSL_2_I.test.cpp.html
